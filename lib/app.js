...
export default class App extends React.Component {
  constructor() {
    ...
    this.supported = Modernizr.webgl && Modernizr.video && !isIphone
  ...
  render() {
    ...
    return <div className={stageClasses}>
      ...
      {VideoPlayerElement}
      <ReactCSSTransitionGroup component="div" className="stage" transitionName="stage" transitionAppear={true} transitionEnter={true} transitionLeave={true} transitionEnterTimeout={300} transitionLeaveTimeout={300} transitionAppearTimeout={300}>
